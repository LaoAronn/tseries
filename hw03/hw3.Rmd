...
```{r, echo=TRUE}
# this is where your R code goes
acf(ts(wage_data.ts.train), main="ACF of Original Series")
...
Based on our gathered forecasts, the true values for are within our prediction intervals and relatively close to our forecast values.