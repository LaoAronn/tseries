...
Based on the coefficients, we observe a exponentially decaying function which
exhibits of a AR(3) process.
...
acf(q3_ts, main = "ACF")
```
Comment on the behavior of the sample acf, and explain whether it appears as you would expect given the model.
